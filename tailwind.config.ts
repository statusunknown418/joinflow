  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "dark-tremor": {
          ...
          background: {
            ...
            DEFAULT: "#18181ba3", // TODO: Update to have transparency
      ...
      animation: {
        ...
        "bg-animation": "bg-animation 3s ease-in-out infinite",
      },
    },
  },
  safelist: [
